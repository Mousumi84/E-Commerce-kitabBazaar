...
export function Home() {
    ...
    const loginApiCall = () => { navigate('/login') }

//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 
    const wishlistPage = () => { navigate('/wishlist') }
                ...
                <nav>
                    <div id="navbar">
                        ...
                        { isLogin ? <div className="islog">
                                        ...
                                        <button onClick={profilePage}><span className="material-icons-outlined">person</span>{User.name}</button>
                                    </div>
                                  : <div className="islog">
